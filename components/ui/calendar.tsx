  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: 'space-y-4',
        caption:
          'flex justify-center pt-1 relative items-center text-white', // ✅ caption (month text) white
        ...
        head_row: 'flex',
        head_cell:
          'text-white rounded-md w-9 font-normal text-[0.9rem]',
        ...
        day_today:
          'border border-red-600 text-white font-semibold rounded-md', 
        day_outside:
