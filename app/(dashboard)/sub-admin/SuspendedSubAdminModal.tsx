...
interface SuspendedSubAdminModalProps {
  open: boolean;
...
export default function SuspendedSubAdminModal({
  open,
  setOpen,
  onSave,
  selectedReason,
}: SuspendedSubAdminModalProps) {
  ...
  return (
    <Modal
      ...
      description="Please select a reason for suspending this sub admin. He will be notified."
      footer={
