...
export default function EditServiceProviderModal({
    ...
    useEffect(() => {
        if (providerData) {
            ...
            setPreview(providerData.image || null);
        }
    }, [providerData, reset]);
            ...
            <div className="max-h-[70vh] overflow-y-auto px-2 pb-4 text-white">
                ...
                <div className="flex flex-col items-center mb-6 relative">
                    <div className="relative">
                        ...
                        >
                            <Image src="images/tabler_award-filled.svg" alt="providerIcon"
                                width={96}
                                height={96}
                                className="object-cover w-full h-full" />
                            <input
                ...
                {/* Description */}
                <div className="mb-4">
                    <label className="block mb-1 text-[16px] font-medium">Description</label>
                    <Textarea
                    ...
                    <div className="flex flex-wrap gap-2">
                        {categories.map((cat) => (
                            <Badge
                                ...
                                className={`cursor-pointer px-4 py-1 rounded-full ${selectedCategories.includes(cat)
