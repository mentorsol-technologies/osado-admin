...
interface SuspendedBookingModalProps {
  open: boolean;
...
export default function SuspendedBookingModal({
  open,
  setOpen,
  onSave,
  selectedReason,
}: SuspendedBookingModalProps) {
  ...
  return (
    <Modal
      ...
      description="Please select a reason for suspending this booking. The user ans service provider will be notified."
      footer={
