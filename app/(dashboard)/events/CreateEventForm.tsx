...
import { useCategoriesQuery, useCreateEventMutation } from "@/hooks/useEventManagementMutations";
            ...
            <div className="max-h-[70vh] overflow-y-auto pr-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <CommonInput placeholder="Enter Price"  {...register("price", { valueAsNumber: true })} />
                        {errors.price && (
                    ...
                    <div>
                        ...
                        <CommonInput
                            placeholder="Enter Price Type" {...register("priceType")}
                        />
                        {errors?.priceType && (
